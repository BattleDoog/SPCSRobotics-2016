...
class virtual_world:
	...
	def in_collision(self):
		...
		x1 = vrobot.l * math.sin(a1) + vrobot.x
		x2 = vrobot.l * math.sin(a2) + vrobot.x
		x3 = vrobot.l * math.sin(a3) + vrobot.x        
		x4 = vrobot.l * math.sin(a4) + vrobot.x

		y1 = -vrobot.l * math.cos(a1) - vrobot.y
		y2 = -vrobot.l * math.cos(a2) - vrobot.y
		y3 = -vrobot.l * math.cos(a3) - vrobot.y
		y4 = -vrobot.l * math.cos(a4) - vrobot.y

		ULRobot = [x1, y1]
		URRobot = [x2, y2]
		DLRobot = [x3, y3]
		DRRobot = [x4, y4]
		print ULRobot, URRobot, DLRobot, DRRobot

		if(radial_intersect(vrobot.a, ULRobot[0], ULRobot[1]) == True or virtual_world.radial_intersect(vrobot.a, URRobot[0], URRobot[1]) == True or virtual_world.radial_intersect(vrobot.a, DLRobot[0], DLRobot[1])==True or virtual_world.radial_intersect(vrobot.a, DRRobot[0], DRRobot[1])==True):
...
"""
		if(-100 < ULRobot[0] < 0 and -180 < ULRobot[1] < -140):
			print("OBSTACLE DETECTED")
			return True
			GUI_part.stop_move()
		elif(-140 < ULRobot[0] < -100 and -180 < ULRobot[1] < -80):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-100 < ULRobot[0] < 0 and 140 < ULRobot[1] < 180):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-140 < ULRobot[0] < -100 and 80 < ULRobot[1] < 180):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(0 < ULRobot[0] < 40 and -50 < ULRobot[1] < 50):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-260 < ULRobot[0] < -220 and -20 < ULRobot[1] < 20):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(40 < ULRobot[0] < 140 and 60 < ULRobot[1] < 100):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-100 < URRobot[0] < 0 and -180 < URRobot[1] < -140):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-140 < URRobot[0] < -100 and -180 < URRobot[1] < -80):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-100 < URRobot[0] < 0 and 140 < URRobot[1] < 180):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-140 < URRobot[0] < -100 and 80 < URRobot[1] < 180):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(0 < URRobot[0] < 40 and -50 < URRobot[1] < 50):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-260 < URRobot[0] < -220 and -20 < URRobot[1] < 20):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(40 < URRobot[0] < 140 and 60 < URRobot[1] < 100):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-100 < DLRobot[0] < 0 and -180 < DLRobot[1] < -140):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-140 < DLRobot[0] < -100 and -180 < DLRobot[1] < -80):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-100 < DLRobot[0] < 0 and 140 < DLRobot[1] < 180):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-140 < DLRobot[0] < -100 and 80 < DLRobot[1] < 180):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(0 < DLRobot[0] < 40 and -50 < DLRobot[1] < 50):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-260 < DLRobot[0] < -220 and -20 < DLRobot[1] < 20):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(40 < DLRobot[0] < 140 and 60 < DLRobot[1] < 100):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-100 < DRRobot[0] < 0 and -180 < DRRobot[1] < -140):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-140 < DRRobot[0] < -100 and -180 < DRRobot[1] < -80):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-100 < DRRobot[0] < 0 and 140 < DRRobot[1] < 180):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-140 < DRRobot[0] < -100 and 80 < DRRobot[1] < 180):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(0 < DRRobot[0] < 40 and -50 < DRRobot[1] < 50):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(-260 < DRRobot[0] < -220 and -20 < DRRobot[1] < 20):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
		elif(40 < DRRobot[0] < 140 and 60 < DRRobot[1] < 100):
			print "OBSTACLE DETECTED"
			return True
			GUI_part.stop_move()
